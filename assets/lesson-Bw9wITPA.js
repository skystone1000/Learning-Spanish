import{r as D,c as R,g,b as x,s as X,a as _,l as G}from"./header-tpRfakPe.js";/* empty css              */import{i as O}from"./explode-BMg1_SZ8.js";import{g as v,i as Y,r as z,a as U}from"./reveal-BBM4lrTc.js";import{g as J}from"./router-CTbApqkT.js";import{g as K,b as Q,c as V}from"./curriculum-DIRFPJHL.js";let y=null;function Z(e){ee();const s=new Audio(e);return y=s,s.play().catch(()=>{y=null}),s}function ee(){y&&(y.pause(),y=null)}function A(e=document){e.querySelectorAll("[data-audio]").forEach(s=>{s.addEventListener("click",()=>Z(s.dataset.audio))})}const T=["#2563eb","#f59e0b","#10b981","#ef4444","#14b8a6","#f43f5e"];function te(e,{xp:s,stars:t,message:r="¡Excelente!"}){if(!e)return Promise.resolve();e.innerHTML=`
  ...
  `}function le(e,s){const t=[...e.words].sort(()=>Math.random()-.5);s.innerHTML=`
    ...
    <div class="feedback-line" aria-live="polite"></div>
  `}function S(e){return String(e).replaceAll('"',"&quot;")}D();R();let f=g();document.body.dataset.theme=f.theme;const de=J()||f.currentLesson,i=K(de),P=document.getElementById("lesson-root"),k=document.getElementById("header-root");i?(X(i.id),f=g(),x(k,f),ue()):(x(k,f),P.innerHTML='<p class="text-center mt-5">Lesson not found.</p>');function ue(){const e=f.mode==="game",s=e?["hook",...i.content.map((o,n)=>`content-${n}`),...i.exercises.map((o,n)=>`exercise-${n}`),"summary"]:["hook",...i.content.map((o,n)=>`content-${n}`),"summary"];let t=0,r=0,d=g().hearts.current;const b=Date.now();P.innerHTML=`
